...
public class EmployeeControllerAuthorizationTest {
    ...
    void createEmployee_shouldReturn403() throws Exception {
    ...
    void getEmployeeById_shouldReturn200() throws Exception {
        ...
        mockMvc.perform(get("/api/employees/" + savedEmployee.getId()))
                ...
                .andExpect(jsonPath("$.firstName").value(savedEmployee.getFirstName()))
                .andExpect(jsonPath("$.lastName").value(savedEmployee.getLastName()))
                .andExpect(jsonPath("$.email").value(savedEmployee.getEmail()));
    }
    ...
    @Test
    @WithMockUser(username = "employee@example.com", roles = "EMPLOYEE")
    void updateEmployee_shouldReturn403() throws Exception {
    ...
    @Test
    @WithMockUser(username = "employee@example.com", roles = "EMPLOYEE")
    void deleteEmployee_shouldReturn403() throws Exception {
